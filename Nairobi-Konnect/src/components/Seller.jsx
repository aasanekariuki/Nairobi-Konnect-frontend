...
const Seller = () => {
  ...
  return (
    <div className="position-relative min-vh-100 d-flex align-items-center justify-content-center" style={{ background: 'linear-gradient(to right, #F4A460, #FFFFFF)' }}>
      ...
      <div className="position-relative bg-custom text-dark p-5 rounded-3xl shadow-2xl w-100" style={{ maxWidth: '800px', margin: '0 auto', borderRadius: '2rem' }}>
        <div className="d-flex flex-column flex-md-row">
          <div style={{ flex: 1, marginRight: '2rem' }}>
            <h2 className="text-center mb-4" style={{ fontWeight: 'bold', color: '#3E2723' }}>Post a New Product</h2>
